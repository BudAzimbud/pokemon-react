                ...
                <Card>
                    ...
                    <CardBody  >
                       ...
                       <div className='d-flex align-items-center gap-2' >
                           <img src={"https://picsum.photos/700"} className="mr-2" style={{widht:40 , height:40 , borderRadius:'50%'}} />
                           <div  style={{fontSize:'12px' , color:'#b9b9c3'}}>by <span className='fw-bold text-secondary'>Ramdani</span> | <Moment fromNow>{props.createdAt}</Moment></div>
                       </div>
                       <div className='mt-3'>
                       {
                       ...
                       <div className='mt-2 border-top py-2  d-flex justify-content-between'>
                            ...
                            <Link style={{color:'#7367f0'}} to={"/berita/"+props.slug}>Read More</Link>
                       </div>
                    </CardBody>
                </Card>
            </Link>
